        ...
        return [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "from": {
                            "type": "string",
                            "description": "3-letter currency code of the currency to convert from",
                        },
                        "to": {
                            "type": "string",
                            "description": "3-letter currency code of the currency to convert to",
                        },
                        "date": {
                            "type": "string",
                            "description": "Historic date to get exchange rate (format YYYY-MM-DD)."
                                            "Only if user requests exchange rate for specific date,"
                                            "rather than current rate",
                        },
                        "amount": {
                            "type": "number",
                            "description": "Amount to be converted (defaults to 1)",
                        },
                    },
                    "required": ["from", "to"],
                },
